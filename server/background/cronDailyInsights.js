    ...
    if (idArray.length >= 1) {
      ...
      const setIntervalId = Meteor.setInterval(function () {
        ...
        */
        ...
        } else if ((dayBreakdown && dayBreakdown.data.inserted) && (moment(dayBreakdown.data.inserted, "MM-DD-YYYY hh:mm a").isAfter(moment(dayBreakdown.data.date_stop, "YYYY-MM-DD")))) {
