...
Meteor.methods({
    ...
    'refreshHourly': (campaignNumber) => {
      HourlyBreakdowns.remove({'data.campaign_id': campaignNumber});
      return "success!";
    },
    'testMethod': () => {
